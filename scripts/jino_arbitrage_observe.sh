...
echo "NO exchange API keys are required for this phase."
echo "No executor/order can be created in this mode."
echo "It reads public Binance/KuCoin market data through paper connectors."
echo "Account balances, authenticated withdrawal status and exact withdrawal fees remain UNVERIFIED until a later read-only-key phase."
